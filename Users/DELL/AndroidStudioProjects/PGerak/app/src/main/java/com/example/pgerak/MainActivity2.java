...
import com.example.pgerak.Models.UserDetails;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://signup-86a1d-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Users");
        signUpBtn = findViewById(R.id.buttonlogin);
        usernameSignUp = findViewById(R.id.usernames);
        emailPengguna = findViewById(R.id.emails);
        passwordSignUp = findViewById(R.id.passwords);
        nimPengguna = findViewById(R.id.nims);
